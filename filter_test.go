...
var filterTests = []templateTest{
	// Test add
	templateTest{"{{ 14|add:1 }}", c{"var": 14}, "15"},
	templateTest{"{{ var|add:1 }}", c{"var": 14}, "15"},
	templateTest{"{{ var|add:-1 }}", c{"var": 14}, "13"},
	templateTest{"{{ var|add:\"1\" }}", c{"var": 14}, "15"},
	templateTest{"{{ var|add:'-1' }}", c{"var": 14}, "13"},
	templateTest{"{{ var|add:1 }}", c{"var": "14"}, "15"},
	templateTest{"{{ var|add:1 }}", nil, "1"},
	templateTest{"{{ var|add:1 }}", c{"var": "a"}, "1"},

	// Test addslashes
	templateTest{"{{ var|addslashes }}", c{"var": "I'm using Django"}, "I\\'m using Django"},
	...
	// Test lower
	templateTest{"{{ var|lower }}", c{"var": "VaR"}, "var"},
}
